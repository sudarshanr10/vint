...
declare const _default: {
    tags: string[];
    title: string;
    component: React.FC<Partial<import('./HistogramBarChart').HistogramBarChartProps>>;
    subcomponents: {
        ...
        BarLabel: React.FC<Partial<import('./BarSeries').BarLabelProps>>;
...
export declare const Dates: () => import("react/jsx-runtime").JSX.Element;
export declare const Numbers: () => import("react/jsx-runtime").JSX.Element;
export declare const MultiMonth: () => import("react/jsx-runtime").JSX.Element;
