...
(function(global, factory) {
...
})(this, function(exports2, jsxRuntime, reablocks, react, humanFormat, d3Array, d3Shape, transformationMatrix, classNames, ellipsize, d3Scale, bigInt, chroma, dom, isEqual, react$1, d3Interpolate, safeIdentifier, d3Geo, d3Sankey, venn_js, invert, d3Hierarchy, cloud) {
  "use strict";
  ...
  const roundDecimals = (value2, decimals = 5) => parseFloat(value2.toFixed(decimals));
  ...
  const mergeDefaultProps = (defaultProps, props = {}) => {
    const filteredProps = Object.fromEntries(
      Object.entries(props).filter(([_, value2]) => value2 !== void 0)
    );
    return { ...defaultProps, ...filteredProps };
  };
  const LinearAxisLine = (props) => {
    const {
      strokeColor,
      strokeWidth,
      strokeGradient,
    ...
    return /* @__PURE__ */ jsxRuntime.jsxs(react.Fragment, { children: [
      ...
      strokeGradient && /* @__PURE__ */ jsxRuntime.jsx(
        reablocks.CloneElement,
        {
  ...
  const linearAxisLineDefaultProps = {
    strokeColor: "#8F979F",
    strokeWidth: 1
  };
  const LinearAxisTickLine = (props) => {
  ...
  const LINEAR_AXIS_TICK_LINE_DEFAULT_PROPS = {
    strokeColor: "#8F979F",
    strokeWidth: 1,
    size: 5
  };
  const LinearAxisTickLabel = (props) => {
    const {
      text,
      fullText,
      angle,
    ...
    function getTickLineSpacing() {
      ...
      const lineProps = { ...LINEAR_AXIS_TICK_LINE_DEFAULT_PROPS, ...line2.props };
      const size = lineProps.size ?? 3;
      const position2 = lineProps.position ?? "center";
      if (position2 === "start") {
        return [size * -1, 0];
    ...
    return /* @__PURE__ */ jsxRuntime.jsxs(
      "g",
      {
        ...
        fontFamily,
        children: [
          /* @__PURE__ */ jsxRuntime.jsx("title", { children: titleHover }),
          /* @__PURE__ */ jsxRuntime.jsx("text", { ...textPosition, fill, className, children: text })
        ]
      }
    );
  };
  const LINEAR_AXIS_TICK_LABEL_DEFAULT_PROPS = {
    fill: "#8F979F",
    fontSize: 11,
  ...
  const LinearAxisTickSeries = (props) => {
    const {
      scale,
      orientation,
      height,
    ...
    const labelProps = react.useMemo(
      () => ({
        ...
        ...(label2 == null ? void 0 : label2.props) ?? {}
      }),
      [label2 == null ? void 0 : label2.props]
    );
    ...
    const ticks = react.useMemo(() => {
      ...
      return ticks2.map((tick) => {
        ...
        const size = label2 ? calculateDimensions(
          ...
          (_a = labelProps.fontSize) == null ? void 0 : _a.toString()
        ) : {};
        return {
          ...position,
          ...size,
    ...
    const angle = react.useMemo(() => {
      ...
      return angle2;
    }, [getDimension2, label2, labelProps, ticks]);
  ...
  const LINEAR_AXIS_TICK_SERIES_DEFAULT_PROPS = {
  ...
  const LinearAxis = (props) => {
    ...
    const tickSeriesProps = react.useMemo(
      () => mergeDefaultProps(
        LINEAR_AXIS_TICK_SERIES_DEFAULT_PROPS,
        tickSeries == null ? void 0 : tickSeries.props
      ),
      [tickSeries == null ? void 0 : tickSeries.props]
    );
    ...
    return /* @__PURE__ */ jsxRuntime.jsxs(
      "g",
      {
        ...
        children: [
          ...
          (tickSeriesProps.line || tickSeriesProps.label) && /* @__PURE__ */ jsxRuntime.jsx(
            reablocks.CloneElement,
            {
              element: tickSeries,
              height,
  ...
  const LINEAR_AXIS_DEFAULT_PROPS = {
    scaled: false,
    roundDomains: false,
    axisLine: /* @__PURE__ */ jsxRuntime.jsx(LinearAxisLine, {}),
    onDimensionsChange: () => void 0
  };
  const LinearXAxisTickLabel = (props) => /* @__PURE__ */ jsxRuntime.jsx(
    LinearAxisTickLabel,
    {
      ...mergeDefaultProps(LINEAR_X_AXIS_TICK_LABEL_DEFAULT_PROPS, props)
    }
  );
  const LINEAR_X_AXIS_TICK_LABEL_DEFAULT_PROPS = {
    ...LINEAR_AXIS_TICK_LABEL_DEFAULT_PROPS,
    rotation: true,
    position: "end",
    align: "center"
  };
  const LinearXAxisTickLine = (props) => /* @__PURE__ */ jsxRuntime.jsx(
    LinearAxisTickLine,
    {
      ...mergeDefaultProps(LINEAR_X_AXIS_TICK_LINE_DEFAULT_PROPS, props)
    }
  );
  const LINEAR_X_AXIS_TICK_LINE_DEFAULT_PROPS = {
    ...LINEAR_AXIS_TICK_LINE_DEFAULT_PROPS,
    position: "end"
  };
  const LinearXAxisTickSeries = (props) => {
    var _a, _b;
    ...
    return /* @__PURE__ */ jsxRuntime.jsx(
      ...
      {
        ...xTickSeriesProps,
        line: (xTickSeriesProps == null ? void 0 : xTickSeriesProps.line) ? /* @__PURE__ */ jsxRuntime.jsx(
          LinearXAxisTickLine,
          {
            ...mergeDefaultProps(
              LINEAR_X_AXIS_TICK_LINE_DEFAULT_PROPS,
              (_a = props == null ? void 0 : props.line) == null ? void 0 : _a.props
            )
          }
        ) : null,
        label: (xTickSeriesProps == null ? void 0 : xTickSeriesProps.label) ? /* @__PURE__ */ jsxRuntime.jsx(
          LinearXAxisTickLabel,
          {
            ...mergeDefaultProps(
              LINEAR_X_AXIS_TICK_LABEL_DEFAULT_PROPS,
              (_b = props == null ? void 0 : props.label) == null ? void 0 : _b.props
            )
          }
        ) : null
      }
  ...
  const LINEAR_X_AXIS_TICK_SERIES_DEFAULT_PROPS = {
    ...LINEAR_AXIS_TICK_SERIES_DEFAULT_PROPS,
    tickSize: 75,
    line: /* @__PURE__ */ jsxRuntime.jsx(LinearXAxisTickLine, { ...LINEAR_X_AXIS_TICK_LINE_DEFAULT_PROPS }),
    label: /* @__PURE__ */ jsxRuntime.jsx(LinearXAxisTickLabel, { ...LINEAR_X_AXIS_TICK_LABEL_DEFAULT_PROPS })
  };
  const LinearXAxis = (props) => {
    var _a;
    ...
    return /* @__PURE__ */ jsxRuntime.jsx(
      ...
      {
        ...xAxisProps,
        tickSeries: xAxisProps.tickSeries && /* @__PURE__ */ jsxRuntime.jsx(
          LinearXAxisTickSeries,
          {
            ...mergeDefaultProps(
              LINEAR_X_AXIS_TICK_SERIES_DEFAULT_PROPS,
              (_a = xAxisProps == null ? void 0 : xAxisProps.tickSeries) == null ? void 0 : _a.props
            )
          }
        )
      }
  ...
  const LINEAR_X_AXIS_DEFAULT_PROPS = {
  ...
  const LinearYAxisTickLabel = (props) => /* @__PURE__ */ jsxRuntime.jsx(
    LinearAxisTickLabel,
    {
      ...mergeDefaultProps(LINEAR_Y_AXIS_TICK_LABEL_DEFAULT_PROPS, props)
    }
  );
  const LINEAR_Y_AXIS_TICK_LABEL_DEFAULT_PROPS = {
    ...LINEAR_AXIS_TICK_LABEL_DEFAULT_PROPS,
    rotation: false,
    position: "start",
    align: "center"
  };
  const LinearYAxisTickLine = (props) => /* @__PURE__ */ jsxRuntime.jsx(
    LinearAxisTickLine,
    {
      ...mergeDefaultProps(LINEAR_Y_AXIS_TICK_LINE_DEFAULT_PROPS, props)
    }
  );
  const LINEAR_Y_AXIS_TICK_LINE_DEFAULT_PROPS = {
    ...LINEAR_AXIS_TICK_LINE_DEFAULT_PROPS,
    position: "start"
  };
  const LinearYAxisTickSeries = (props) => {
    var _a, _b;
    ...
    return /* @__PURE__ */ jsxRuntime.jsx(
      ...
      {
        ...yTickSeriesProps,
        line: (yTickSeriesProps == null ? void 0 : yTickSeriesProps.line) ? /* @__PURE__ */ jsxRuntime.jsx(
          LinearYAxisTickLine,
          {
            ...mergeDefaultProps(
        ...
        label: (yTickSeriesProps == null ? void 0 : yTickSeriesProps.label) ? /* @__PURE__ */ jsxRuntime.jsx(
  ...
  const LINEAR_Y_AXIS_TICK_SERIES_DEFAULT_PROPS = {
    ...LINEAR_AXIS_TICK_SERIES_DEFAULT_PROPS,
    tickSize: 30,
    line: /* @__PURE__ */ jsxRuntime.jsx(LinearYAxisTickLine, { ...LINEAR_Y_AXIS_TICK_LINE_DEFAULT_PROPS }),
    label: /* @__PURE__ */ jsxRuntime.jsx(LinearYAxisTickLabel, { ...LINEAR_Y_AXIS_TICK_LABEL_DEFAULT_PROPS })
  };
  const LinearYAxis = (props) => {
    var _a;
    ...
    return /* @__PURE__ */ jsxRuntime.jsx(
      ...
      {
        ...yAxisProps,
        tickSeries: yAxisProps.tickSeries && /* @__PURE__ */ jsxRuntime.jsx(
          LinearYAxisTickSeries,
          {
            ...mergeDefaultProps(
              LINEAR_Y_AXIS_TICK_SERIES_DEFAULT_PROPS,
              (_a = yAxisProps == null ? void 0 : yAxisProps.tickSeries) == null ? void 0 : _a.props
            )
          }
        )
      }
  ...
  const LINEAR_Y_AXIS_DEFAULT_PROPS = {
    ...LINEAR_AXIS_DEFAULT_PROPS,
  ...
  const RadialAxisTickLine = (props) => {
  ...
  const RADIAL_AXIS_TICK_LINE_DEFAULT_PROPS = {
  ...
  const RadialAxisTick = ({
    line: line2 = /* @__PURE__ */ jsxRuntime.jsx(RadialAxisTickLine, {}),
    label: label2 = /* @__PURE__ */ jsxRuntime.jsx(RadialAxisTickLabel, {}),
    scale,
    outerRadius = 0,
    data,
    index,
    ...
    const lineProps = react.useMemo(
      () => ({ ...RADIAL_AXIS_TICK_LINE_DEFAULT_PROPS, ...(line2 == null ? void 0 : line2.props) ?? {} }),
      [line2 == null ? void 0 : line2.props]
    );
    ...
    const lineSize = line2 ? lineProps.size : 0;
    return /* @__PURE__ */ jsxRuntime.jsxs("g", { transform, children: [
      line2 && /* @__PURE__ */ jsxRuntime.jsx(
        reablocks.CloneElement,
        {
  ...
  const RADIAL_AXIS_ARC_DEFAULT_PROPS = {
    stroke: "#71808d",
    strokeDasharray: "1,4",
    startAngle: 0,
    endAngle: 2 * Math.PI
  ...
  const RadialAxisArcSeries = (props) => {
    const {
      count,
      innerRadius,
      outerRadius,
  ...
  const RADIAL_AXIS_ARC_SERIES_DEFAULT_PROPS = {
    count: 12,
    arc: /* @__PURE__ */ jsxRuntime.jsx(RadialAxisArc, {}),
    startAngle: 0,
    endAngle: 2 * Math.PI
  };
  const RadialAxisArcLine = (props) => {
  ...
  const RADIAL_AXIS_ARC_LINE_DEFAULT_PROPS = {
    stroke: "#71808d"
  };
  const RadialAxis = (props) => {
    const {
      arcs,
      ticks,
      xScale,
  ...
  const RADIAL_AXIS_DEFAULT_PROPS = {
    innerRadius: 10,
    type: "value",
  ...
  const Move = ({
    ...
    const disableTextSelection = (shouldDisable) => {
      if (disableText) {
    ...
    return /* @__PURE__ */ jsxRuntime.jsx(
      Move,
      {
        ...
        children: /* @__PURE__ */ jsxRuntime.jsxs("g", { children: [
          /* @__PURE__ */ jsxRuntime.jsx("line", { className: css$t.line, y1: "0", y2: height, x1: "5", x2: "5" }),
          /* @__PURE__ */ jsxRuntime.jsx(
            "rect",
            {
              className: classNames(css$t.handle, { [css$t.dragging]: isDragging }),
              height: height - 10,
          ...
          /* @__PURE__ */ jsxRuntime.jsx(
            "g",
            {
              ...
              style: { pointerEvents: "none" },
              children: d3Array.range(5).map((i) => /* @__PURE__ */ jsxRuntime.jsx("circle", { cy: i * 5, cx: "5", r: ".5", className: css$t.dot }, i))
            }
          )
        ] })
      }
  ...
  const BrushSlice = (props) => {
    ...
    return /* @__PURE__ */ jsxRuntime.jsxs(react.Fragment, { children: [
      /* @__PURE__ */ jsxRuntime.jsx("rect", { className: css$s.unsliced, height, width: start2 }),
      /* @__PURE__ */ jsxRuntime.jsx(
        "rect",
        {
          transform: `translate(${end2}, 0)`,
          className: css$s.unsliced,
          height,
          width: endSliceWidth
        }
      ),
  ...
  const Brush = (props) => {
    ...
    const ensurePositionInBounds = react.useCallback(
      (newStart, newEnd) => {
    ...
    const getStartEnd = react.useCallback(
      (event) => {
    ...
    const onSliceChange = react.useCallback(
      (event) => {
          ...
          "g",
          {
            ...
            children: [
              ...
              !disabled && /* @__PURE__ */ jsxRuntime.jsxs(jsxRuntime.Fragment, { children: [
                /* @__PURE__ */ jsxRuntime.jsx("rect", { ref, height, width, opacity: 0 }),
  ...
  const ChartBrush = (props) => {
    ...
    const onBrushChangeHandler = react.useCallback(
      (event) => {
        if (onBrushChange) {
          let domain2;
  ...
  const ChartContainer = ({
    ...
    const curId = reablocks.useId(id);
    ...
    return /* @__PURE__ */ jsxRuntime.jsx(
      "div",
      {
        ...
        className: classNames(containerClassName, css$r.container),
        ...rest,
        children: /* @__PURE__ */ jsxRuntime.jsx(ChartProvider, { value: childProps, children: height > 0 && width > 0 && /* @__PURE__ */ jsxRuntime.jsx(
          "svg",
          {
            width,
            height,
            className: classNames(css$r.svg, className),
            style,
            tabIndex: 0,
  ...
  const _Pan = class _Pan extends react.Component {
    constructor() {
      super(...arguments);
  ...
  const _Zoom = class _Zoom extends react.Component {
    constructor() {
      super(...arguments);
      this.childRef = react.createRef();
  ...
  const DiscreteLegend = ({
    ...
    "div",
    {
      className: classNames(css$q.container, className, {
  ...
  const DiscreteLegendSymbol = ({
    ...
    "div",
    {
      className: classNames(css$p.symbol, className),
  ...
  const DiscreteLegendEntry = ({
    label: label2,
    symbol: symbol2 = /* @__PURE__ */ jsxRuntime.jsx(DiscreteLegendSymbol, {}),
    title,
    className,
    color,
    style,
    ...
    {
      title,
      className: classNames(css$o.entry, className, {
      ...
      style,
      children: [
        /* @__PURE__ */ jsxRuntime.jsx(reablocks.CloneElement, { element: symbol2, color }),
        /* @__PURE__ */ jsxRuntime.jsx("span", { className: css$o.label, children: label2 })
      ]
    }
  );
  ...
  const SequentialLegend = ({
    ...
    const [end2, start2] = react.useMemo(
      () => d3Array.extent(
        uniqueBy(
          data,
          (d) => d.data,
    ...
    return /* @__PURE__ */ jsxRuntime.jsxs(
      ...
      {
        style,
        className: classNames(css$n.container, className, {
          [css$n.vertical]: orientation === "vertical",
          [css$n.horizontal]: orientation === "horizontal"
        }),
        children: [
          /* @__PURE__ */ jsxRuntime.jsx("div", { className: css$n.start, children: formatValue(start2) }),
          /* @__PURE__ */ jsxRuntime.jsx(
            "div",
            {
              className: classNames(css$n.gradient, gradientClassName),
              style: {
                background: `linear-gradient(${gradientDir}${color})`
              }
            }
          ),
          /* @__PURE__ */ jsxRuntime.jsx("div", { className: css$n.end, children: formatValue(end2) })
        ]
      }
    );
  };
  ...
  const Gridline = (props) => {
    ...
    return /* @__PURE__ */ jsxRuntime.jsx(
      ...
      {
        ...coords,
        className: classNames(css$m.gridLine, className),
        strokeDasharray,
        strokeWidth,
        stroke: strokeColor,
        fill: "none"
  ...
  const GridStripe = (props) => {
    ...
    return /* @__PURE__ */ jsxRuntime.jsx("rect", { className: classNames(css$l.gridStripe, className), ...coords });
  };
  const GRID_STRIPE_DEFAULT_PROPS = {
    fill: "#393c3e"
  };
  const GridlineSeries = ({
    line: line2 = /* @__PURE__ */ jsxRuntime.jsx(Gridline, { direction: "all" }),
    stripe,
    yScale,
    xScale,
    yAxis,
    ...
    const lineProps = react.useMemo(
      () => ({ ...GRID_LINE_DEFAULT_PROPS, ...line2.props }),
      [line2.props]
    );
    const stripeProps = react.useMemo(
      () => ({ ...GRID_STRIPE_DEFAULT_PROPS, ...(stripe == null ? void 0 : stripe.props) ?? {} }),
      [stripe == null ? void 0 : stripe.props]
    );
    ...
    const renderSeries = react.useCallback(
      (yAxisGrid2, xAxisGrid2, element, direction, type) => {
        return /* @__PURE__ */ jsxRuntime.jsxs(react.Fragment, { children: [
          shouldRenderY(direction) && renderGroup(element, yAxisGrid2, yScale, "y", type),
          shouldRenderX(direction) && renderGroup(element, xAxisGrid2, xScale, "x", type)
        ] });
      },
      [renderGroup, xScale, yScale]
    );
    return /* @__PURE__ */ jsxRuntime.jsxs("g", { style: { pointerEvents: "none" }, children: [
      line2 && renderSeries(yAxisGrid, xAxisGrid, line2, lineProps.direction, "line"),
      stripe && renderSeries(
        yAxisGrid,
        xAxisGrid,
        stripe,
  ...
  const TooltipTemplate = ({
    ...
    const renderValues = (data, index) => {
      ...
      return /* @__PURE__ */ jsxRuntime.jsxs("span", { className: css$j.subValue, children: [
        /* @__PURE__ */ jsxRuntime.jsx("span", { className: css$j.subValueColor, style: { backgroundColor: fill } }),
        /* @__PURE__ */ jsxRuntime.jsxs("span", { className: css$j.subValueName, children: [
    ...
    return /* @__PURE__ */ jsxRuntime.jsxs("div", { className, role: "tooltip", children: [
      /* @__PURE__ */ jsxRuntime.jsx("div", { className: css$j.label, children: formatValue(value2.x) }),
      /* @__PURE__ */ jsxRuntime.jsxs("div", { className: css$j.value, children: [
  ...
  const tooltipTheme = {
    base: css$i.base,
    disablePointer: css$i.disablePointer
  };
  const ChartTooltip = ({
  ...
  const TooltipArea = react.forwardRef(
    ({
      ...
      const getXCoord = react.useCallback(
        (x, y) => {
          if (isRadial) {
      ...
      const renderRadial = react.useCallback(() => {
        ...
        return /* @__PURE__ */ jsxRuntime.jsxs(jsxRuntime.Fragment, { children: [
          /* @__PURE__ */ jsxRuntime.jsx("path", { d: fullCircle, opacity: "0", cursor: "auto", ref: fullCircleref }),
          /* @__PURE__ */ jsxRuntime.jsx(
            "path",
            {
              d,
        ...
        !disabled && /* @__PURE__ */ jsxRuntime.jsxs("g", { onMouseLeave, ref: childRef, children: [
          ...
          /* @__PURE__ */ jsxRuntime.jsx(
            reablocks.CloneElement,
            {
              ...
              visible,
              placement,
              modifiers: [dom.offset({ mainAxis: 15 }), dom.flip()],
  ...
  const ZoomPan = ({
    ...
    const onPanStartHandler = react.useCallback(
      (event) => {
        setIsPanning(true);
        onPanStart(event);
      },
    ...
    const onPanMoveHandler = react.useCallback(
      (event) => {
        onZoomPan({
          scale,
          x: event.x,
    ...
    const onPanEndHandler = react.useCallback(
      (event) => {
        setIsPanning(false);
        onPanEnd(event);
      },
  ...
  const ChartZoomPan = ({
    ...
    const onZoomPanHandler = react.useCallback(
      (event) => {
  ...
  const MotionPath = ({ custom, transition, ...rest }) => {
    const d = react$1.useMotionValue(custom.exit.d);
    const spring = react$1.useSpring(0, DEFAULT_TRANSITION);
    react.useEffect(() => {
      const interpolator = d3Interpolate.interpolate(d.get(), custom.enter.d);
  ...
  const useCount = ({
    ...
    react.useEffect(() => {
      ...
      const controls = react$1.animate(from, to, {
        duration,
        delay,
        onUpdate(value2) {
  ...
  const ScatterPoint = (props) => {
    ...
    const ariaLabelData = react.useMemo(() => getAriaLabel(data), [data]);
      ...
      /* @__PURE__ */ jsxRuntime.jsx(
        "g",
        {
          ...
          className: classNames({
            [css$h.inactive]: !active,
            [css$h.hidden]: !isVisible
          }),
          onMouseEnter: () => {
  ...
  const SCATTER_POINT_DEFAULT_PROPS = {
    active: true,
  ...
  const ScatterSeries = ({
    ...
    isZoomed,
    activeIds,
    point: point2 = /* @__PURE__ */ jsxRuntime.jsx(ScatterPoint, {}),
    valueMarkers,
    xScale,
    yScale,
    ...rest
    ...
    const renderPoint = react.useCallback(
      ...
      [activeIds, point2, xScale, yScale, rest, id]
    );
    const renderValueMarkers = react.useCallback(
      () => /* @__PURE__ */ jsxRuntime.jsx(jsxRuntime.Fragment, { children: (valueMarkers == null ? void 0 : valueMarkers.length) && valueMarkers.map((marker2) => {
        var _a;
  ...
  const ScatterPlot = ({
    ...
    return /* @__PURE__ */ jsxRuntime.jsx(
      ChartContainer,
      {
        ...
        className: classNames(css$g.scatterPlot, className),
  ...
  const POINT_SERIES_DEFAULT_PROPS = {
    show: "hover",
    ...
    const getAreaPath = react.useCallback(
      (d) => {
        if (d.length === 1 && total === 1) {
          const [point2] = d;
          const midpoint = roundDecimals(point2.x);
          d = [{ ...point2 }, { ...point2 }];
          const [start2, end2] = d;
          start2.x = 0;
          end2.x = midpoint * 2;
        }
        const fn = d3Shape.area().x((d2) => roundDecimals(d2.x)).y0((d2) => roundDecimals(d2.y0)).y1((d2) => roundDecimals(d2.y1)).curve(interpolate(interpolation));
        return fn(d);
      },
      [interpolation, total]
    );
  ...
  const Line = ({
    ...
    const getLinePath = react.useCallback(
      (point2) => {
        const fn = d3Shape.line().x((d) => roundDecimals(d.x)).y((d) => roundDecimals(d.y1)).defined((d) => showZeroStroke || calculateShowStroke(d, point2)).curve(interpolate(interpolation));
        return fn(point2);
      },
    ...
    const strokeFill = react.useMemo(() => {
      if (gradient2) {
        return `url(#gradient-${id})`;
      }
      return stroke;
  ...
  const AreaSeries = (props) => {
    ...
    const symbolsProps = react.useMemo(
      () => ({
        ...POINT_SERIES_DEFAULT_PROPS,
        ...(symbols == null ? void 0 : symbols.props) ?? {}
      }),
      [symbols]
    );
    ...
    const renderSymbols = react.useCallback(
      (data2, index = 0) => {
        ...
        const activeSymbols = symbols && symbolsProps.activeValues || activeValues;
    ...
    const renderMarkLine = react.useCallback(
      () => /* @__PURE__ */ jsxRuntime.jsx(jsxRuntime.Fragment, { children: activeValues && markLine2 && /* @__PURE__ */ jsxRuntime.jsx(
        reablocks.CloneElement,
        {
          element: markLine2,
          height,
  ...
  const AREA_SERIES_DEFAULT_PROPS = {
  ...
  const StackedNormalizedAreaSeries = (props) => {
  ...
  const StackedAreaSeries = (props) => {
    ...
    const pointProps = react.useMemo(
      () => {
        var _a;
        return {
          ...SCATTER_POINT_DEFAULT_PROPS,
          ...(_a = symbolsProps.point) == null ? void 0 : _a.props
        };
      },
      [symbolsProps]
    );
  ...
  const AreaChart = (props) => {
    ...
    const seriesProps = react.useMemo(
  ...
  const AREA_CHART_DEFAULT_PROPS = {
    data: [],
    xAxis: /* @__PURE__ */ jsxRuntime.jsx(LinearXAxis, { type: "time" }),
    yAxis: /* @__PURE__ */ jsxRuntime.jsx(LinearYAxis, { type: "value" }),
  ...
  const StackedAreaChart = (props) => {
    ...
    return /* @__PURE__ */ jsxRuntime.jsx(
      ...
      {
        ...props,
        series: /* @__PURE__ */ jsxRuntime.jsx(StackedAreaSeries, { ...(_a = props.series) == null ? void 0 : _a.props, type: "stacked" })
      }
    );
  };
  const StackedNormalizedAreaChart = (props) => {
    var _a, _b;
    return /* @__PURE__ */ jsxRuntime.jsx(
      AreaChart,
      {
        ...
        series: /* @__PURE__ */ jsxRuntime.jsx(
          ...
          {
            ...(_a = props.series) == null ? void 0 : _a.props,
            type: "stackedNormalized"
          }
        ),
        yAxis: /* @__PURE__ */ jsxRuntime.jsx(
          LinearYAxis,
          {
            ...
            ...(_b = props.yAxis) == null ? void 0 : _b.props
          }
        )
      }
    );
  ...
  const Bar = (props) => {
    ...
    const labelProps = react.useMemo(
      () => ({ ...BAR_LABEL_DEFAULT_PROPS, ...label2 == null ? void 0 : label2.props }),
      [label2 == null ? void 0 : label2.props]
    );
    const isVertical = react.useMemo(() => layout === "vertical", [layout]);
    ...
    const ariaLabelData = react.useMemo(() => getAriaLabel(tooltipData), [tooltipData]);
  ...
  const BarSeries = (props) => {
    ...
    const getTransform = react.useCallback(
      (data2) => {
        ...
        if (type !== "marimekko") {
          if (layout === "vertical") {
            xPos = xScale(data2.key);
          } else {
            yPos = yScale(data2.key);
          }
        }
    ...
    const renderBar = react.useCallback(
      (data2, barIndex, barCount, groupIndex) => {
        ...
        if (!bar2) {
          barElements = /* @__PURE__ */ jsxRuntime.jsx(Bar, { ...BAR_DEFAULT_PROPS });
        }
    ...
    const renderValueMarkers = react.useCallback(
      () => /* @__PURE__ */ jsxRuntime.jsx(jsxRuntime.Fragment, { children: (valueMarkers == null ? void 0 : valueMarkers.length) && valueMarkers.map((marker2) => /* @__PURE__ */ jsxRuntime.jsx(
        reablocks.CloneElement,
        {
          element: marker2,
          size: layout === "vertical" ? width : height,
          value: layout === "vertical" ? yScale(marker2.props.value) : xScale(marker2.props.value),
  ...
  const BAR_SERIES_DEFAULT_PROPS = {
    type: "standard",
    padding: 0.1,
    groupPadding: 16,
    animated: true,
    tooltip: /* @__PURE__ */ jsxRuntime.jsx(
      TooltipArea,
      {
        tooltip: /* @__PURE__ */ jsxRuntime.jsx(ChartTooltip, { followCursor: true, modifiers: [dom.offset(5)] })
      }
    ),
    colorScheme: "cybertron",
  ...
  const StackedBarSeries = (props) => /* @__PURE__ */ jsxRuntime.jsx(BarSeries, { ...STACKED_BAR_SERIES_DEFAULT_PROPS, ...props });
  const STACKED_BAR_SERIES_DEFAULT_PROPS = {
  ...
  const StackedNormalizedBarSeries = (props) => /* @__PURE__ */ jsxRuntime.jsx(BarSeries, { ...STACKED_NORMALIZED_BAR_SERIES_DEFAULT_PROPS, ...props });
  const STACKED_NORMALIZED_BAR_SERIES_DEFAULT_PROPS = {
    ...BAR_SERIES_DEFAULT_PROPS,
    type: "stackedNormalized",
    tooltip: /* @__PURE__ */ jsxRuntime.jsx(
      TooltipArea,
  ...
  const MarimekkoBarSeries = (props) => /* @__PURE__ */ jsxRuntime.jsx(BarSeries, { ...MARIMEKKO_BAR_SERIES_DEFAULT_PROPS, ...props });
  const MARIMEKKO_BAR_SERIES_DEFAULT_PROPS = {
    ...BAR_SERIES_DEFAULT_PROPS,
    type: "marimekko",
    padding: 10,
    tooltip: /* @__PURE__ */ jsxRuntime.jsx(
  ...
  const HistogramBarSeries = ({
    type,
    ...rest
  }) => /* @__PURE__ */ jsxRuntime.jsx(BarSeries, { ...HISTOGRAM_BAR_SERIES_DEFAULT_PROPS, ...rest });
  ...
  const BarChart = (props) => {
    ...
    const seriesProps = react.useMemo(
      () => ({ ...BAR_SERIES_DEFAULT_PROPS, ...series == null ? void 0 : series.props }),
      [series == null ? void 0 : series.props]
    );
    const xAxisProps = react.useMemo(
      () => ({ ...LINEAR_X_AXIS_DEFAULT_PROPS, ...xAxis.props }),
      [xAxis.props]
    ...
    const keyAxisProps = react.useMemo(
    ...
    const getMarimekkoGroupScales = react.useCallback(
      (aggregatedData, axisProps, width2) => {
        const keyScale = getMarimekkoScale(width2, axisProps.roundDomains);
    ...
    const getKeyScale = react.useCallback(
      (aggregatedData, axisProps, isMultiSeries, width2) => {
        return getXScale({
          width: width2,
          type: axisProps.type,
    ...
    const getValueScale2 = react.useCallback(
      (aggregatedData, axisProps, isMultiSeries, height2) => {
        return getYScale({
          roundDomains: axisProps.roundDomains,
          padding: seriesProps.padding,
          type: axisProps.type,
    ...
    return /* @__PURE__ */ jsxRuntime.jsx(
      ChartContainer,
      {
        ...
        xAxisVisible: isAxisVisible(xAxisProps),
        yAxisVisible: isAxisVisible(yAxisProps),
        className: classNames(css$d.barChart, className, css$d[seriesProps.type]),
        children: renderChart
      }
    );
  };
  ...
  const MarimekkoChart = (props) => /* @__PURE__ */ jsxRuntime.jsx(
    BarChart,
    {
  ...
  const StackedBarChart = (props) => /* @__PURE__ */ jsxRuntime.jsx(
    BarChart,
    {
      ...props,
      series: /* @__PURE__ */ jsxRuntime.jsx(
  ...
  const StackedNormalizedBarChart = (props) => /* @__PURE__ */ jsxRuntime.jsx(
    BarChart,
    {
  ...
  const HistogramBarChart = (props) => /* @__PURE__ */ jsxRuntime.jsx(
    BarChart,
    {
      ...props,
      series: /* @__PURE__ */ jsxRuntime.jsx(
  ...
  const LineSeries = (props) => /* @__PURE__ */ jsxRuntime.jsx(AreaSeries, { area: null, line: /* @__PURE__ */ jsxRuntime.jsx(Line, { strokeWidth: 3 }), ...props });
  const LineChart = (props) => /* @__PURE__ */ jsxRuntime.jsx(AreaChart, { series: /* @__PURE__ */ jsxRuntime.jsx(LineSeries, {}), ...props });
  const Map$1 = ({
    id,
    width,
    height,
    ...
    return /* @__PURE__ */ jsxRuntime.jsxs(react.Fragment, { children: [
      ...
      tooltip2 && /* @__PURE__ */ jsxRuntime.jsx(
        reablocks.Tooltip,
        {
          ...
          visible: active,
          reference: ref,
          modifiers: [dom.offset({ mainAxis: 0, crossAxis: 3 })],
          content: tooltip2
        }
      )
    ] });
  };
  const useInterpolate$2 = ({ data, animated, arc }) => {
    const exit = react.useMemo(() => {
    ...
    const prevData = react.useRef(exit);
    const d = react$1.useMotionValue(exit);
    const spring = react$1.useSpring(0, DEFAULT_TRANSITION);
    react.useEffect(() => {
      const interpolator = d3Interpolate.interpolate(prevData.current, data);
      const prevSpring = spring.get();
      spring.set(prevSpring + 1);
  ...
  const PieArc = ({
    ...
    const d = useInterpolate$2({ animated, arc, data });
    const [active, setActive] = react.useState(false);
    const fill = react.useMemo(
  ...
  const PIE_ARC_LABEL_DEFAULT_PROPS = {
    format: void 0,
  ...
  const PieArcSeries = (props) => {
    ...
    const labelProps = react.useMemo(
      () => ({ ...PIE_ARC_LABEL_DEFAULT_PROPS, ...label2 == null ? void 0 : label2.props }),
      [label2]
    );
  ...
  const PIE_ARC_SERIES_DEFAULT_PROPS = {
    animated: true,
    colorScheme: "cybertron",
    innerRadius: 0,
    cornerRadius: 0,
  ...
  const PieChart = ({
    ...
    const newId = reablocks.useId(id);
  ...
  const Sankey = ({
    ...
    const id = reablocks.useId(rest.id);
  ...
  const SankeyLabel = ({
    ...
    node: node2,
    position = "inside",
    opacity = (active2, disabled2) => active2 ? 1 : disabled2 ? 0.2 : 0.9,
    padding,
    visible = true,
    ellipsis = "auto",
    labelPadding
    ...
    return /* @__PURE__ */ jsxRuntime.jsx(
      "text",
      {
        className: classNames(css$b.label, className),
        x,
        y,
        dy: "0.35em",
        textAnchor,
  ...
  const SankeyLink = ({
    gradient: gradient2 = true,
    index,
    source,
    target,
    tooltip: tooltip2 = /* @__PURE__ */ jsxRuntime.jsx(reablocks.Tooltip, { theme: tooltipTheme, followCursor: true, modifiers: [dom.offset(5)] }),
    chartId,
    value: value2,
    active = false,
    animated = true,
    className,
    disabled = false,
    opacity = (active2, disabled2) => active2 ? 0.5 : disabled2 ? 0.1 : 0.35,
    style,
    width = 0,
    color,
    y0,
    ...
    const renderTooltipContent = react.useCallback(() => {
      return /* @__PURE__ */ jsxRuntime.jsxs("div", { className: css$a.tooltip, children: [
        /* @__PURE__ */ jsxRuntime.jsx("div", { className: css$a.tooltipLabel, children: `${source.title} → ${target.title}` }),
        /* @__PURE__ */ jsxRuntime.jsx("div", { className: css$a.tooltipValue, children: formatValue(value2) })
      ] });
    ...
    return /* @__PURE__ */ jsxRuntime.jsxs(react.Fragment, { children: [
      ...
      /* @__PURE__ */ jsxRuntime.jsx("g", { ref: linkRef, children: /* @__PURE__ */ jsxRuntime.jsx(
        react$1.motion.path,
        {
          className: classNames(css$a.link, className),
          style,
          initial: exitProps,
          animate: enterProps,
          exit: exitProps,
  ...
  const SankeyNode = ({
    ...
    animated = true,
    chartWidth,
    label: label2 = /* @__PURE__ */ jsxRuntime.jsx(SankeyLabel, {}),
    labelPosition,
    labelPadding,
    tooltip: tooltip2 = /* @__PURE__ */ jsxRuntime.jsx(reablocks.Tooltip, { theme: tooltipTheme, followCursor: true, modifiers: [dom.offset(5)] }),
    title,
    ...
    const renderTooltipContent = react.useCallback(() => {
      return /* @__PURE__ */ jsxRuntime.jsxs("div", { className: css$9.tooltip, children: [
        /* @__PURE__ */ jsxRuntime.jsx("div", { className: css$9.tooltipLabel, children: title }),
      ...
      /* @__PURE__ */ jsxRuntime.jsx(
        react$1.motion.g,
        {
          ...
          children: /* @__PURE__ */ jsxRuntime.jsx(
            react$1.motion.rect,
            {
              className: classNames(css$9.node, className),
  ...
  const SparklineChart = (props) => /* @__PURE__ */ jsxRuntime.jsx(
    LineChart,
    {
      gridlines: null,
      series: /* @__PURE__ */ jsxRuntime.jsx(
  ...
  const AreaSparklineChart = (props) => /* @__PURE__ */ jsxRuntime.jsx(
    AreaChart,
    {
      gridlines: null,
      series: /* @__PURE__ */ jsxRuntime.jsx(
  ...
  const BarSparklineChart = (props) => /* @__PURE__ */ jsxRuntime.jsx(
    BarChart,
    {
      gridlines: null,
  ...
  const RadialArea = ({
    ...
    innerRadius,
    interpolation,
    gradient: gradient2 = /* @__PURE__ */ jsxRuntime.jsx(RadialGradient, {}),
    isClosedCurve = true
  }) => {
    const transition = react.useMemo(
      () => animated ? {
  ...
  const RadialScatterPoint = (props) => {
    const {
      size,
      data,
      color,
    ...
    return /* @__PURE__ */ jsxRuntime.jsxs(react.Fragment, { children: [
      /* @__PURE__ */ jsxRuntime.jsxs(
        react$1.motion.g,
        {
          ...
          onClick,
          className: classNames(className, {
            [css$8.inactive]: !active,
            [css$8.hidden]: !isVisible
          }),
          tabIndex: 0,
          "aria-label": ariaLabelData,
          role: "graphics-document",
  ...
  const RADIAL_SCATTER_POINT_DEFAULT_PROPS = {
    size: 3,
    color: schemes.cybertron[0],
    tooltip: /* @__PURE__ */ jsxRuntime.jsx(ChartTooltip, {}),
    active: true,
  ...
  const RadialScatterSeries = ({
    data,
    point: point2 = /* @__PURE__ */ jsxRuntime.jsx(RadialScatterPoint, {}),
    xScale,
    yScale,
    animated = true,
    activeIds,
    ...
    const pointProps = react.useMemo(
      () => ({ ...RADIAL_SCATTER_POINT_DEFAULT_PROPS, ...(point2 == null ? void 0 : point2.props) ?? {} }),
      [point2 == null ? void 0 : point2.props]
    );
    const [internalActiveIds, setInternalActiveIds] = react.useState(
      activeIds
    );
    react.useEffect(() => {
    ...
    const isVisible = react.useCallback(() => show, [show]);
    const renderPoint = react.useCallback(
      (d, index) => {
        let dataId;
        if (d.id) {
        ...
        const pointVisible = pointProps == null ? void 0 : pointProps.visible;
  ...
  const RadialPointSeries = (props) => {
    const { data, xScale, yScale, animated, color, activeValues, show, point: point2 } = {
  ...
  const RADIAL_POINT_SERIES_DEFAULT_PROPS = {
    show: "hover",
    point: /* @__PURE__ */ jsxRuntime.jsx(RadialScatterPoint, {})
  };
  const RadialAreaSeries = (props) => {
    const {
      area,
      line: line2,
      symbols,
  ...
  const RADIAL_AREA_SERIES_DEFAULT_PROPS = {
  ...
  const RadialAreaChart = ({
    ...
    const axisProps = react.useMemo(
      () => ({ ...RADIAL_AXIS_DEFAULT_PROPS, ...(axis == null ? void 0 : axis.props) ?? {} }),
      [axis == null ? void 0 : axis.props]
    );
  ...
  const MotionBar = ({ custom, transition, arc, ...rest }) => {
    const d = react$1.useMotionValue("");
  ...
  const RadialBarSeries = ({
    ...
    height,
    width,
    tooltip: tooltip2 = /* @__PURE__ */ jsxRuntime.jsx(TooltipArea, { tooltip: /* @__PURE__ */ jsxRuntime.jsx(ChartTooltip, { followCursor: true }) }),
    colorScheme = schemes.cybertron[0],
    bar: bar2 = /* @__PURE__ */ jsxRuntime.jsx(RadialBar, {}),
    animated = true,
    startAngle = 0,
    endAngle = 2 * Math.PI,
    type = "standard",
    ...
    return /* @__PURE__ */ jsxRuntime.jsxs(
      reablocks.CloneElement,
      {
        ...
        endAngle,
        children: [
          isMultiSeries ? data.map((groupData, index) => /* @__PURE__ */ jsxRuntime.jsx("g", { children: renderBarGroup(
            groupData.data,
            data.length,
  ...
  const RadialBarChart = ({
    ...
    const seriesProps = react.useMemo(
      () => ({ ...RADIAL_AXIS_DEFAULT_PROPS, ...(series == null ? void 0 : series.props) ?? {} }),
      [series == null ? void 0 : series.props]
    );
    const getXScale2 = react.useCallback(
      (points) => {
  ...
  const RadialGaugeLabel = ({
    ...
    return /* @__PURE__ */ jsxRuntime.jsx(
      "text",
      {
        ...
        className: classNames(className, css$7.valueLabel),
        children: label2
      }
    );
  };
  ...
  const RadialGaugeOuterArc = (props) => /* @__PURE__ */ jsxRuntime.jsx(RadialGaugeArc, { animated: false, disabled: true, ...props });
  const RadialGaugeSeries = ({
    ...
    label: label2 = /* @__PURE__ */ jsxRuntime.jsx(RadialGaugeLabel, {}),
    valueLabel: valueLabel2 = /* @__PURE__ */ jsxRuntime.jsx(RadialGaugeValueLabel, {}),
    colorScheme = ["#00ECB1"],
    id,
    padding = 20,
    minGaugeWidth = 50,
    ...
    const renderGauge = react.useCallback(
      (point2, index) => {
        ...
        return /* @__PURE__ */ jsxRuntime.jsxs("g", { transform: `translate(${xOffset}, ${yOffset})`, children: [
  ...
  const StackedRadialGaugeValueLabel = ({ label: label2, className, yOffset = 0 }) => /* @__PURE__ */ jsxRuntime.jsx(jsxRuntime.Fragment, { children: label2 && /* @__PURE__ */ jsxRuntime.jsx(
    "text",
    {
      x: "0",
      y: yOffset,
      ...
      className: classNames(className, css$5.stackedValueLabel),
      children: label2
    }
  ) });
  ...
  const StackedRadialGaugeSeries = ({
    ...
    label: label2 = /* @__PURE__ */ jsxRuntime.jsx(StackedRadialGaugeValueLabel, {}),
    descriptionLabel,
    colorScheme = ["#00ECB1"],
    fillFactor = 0.2,
    arcPadding = 0.15
  ...
  const StackedRadialGaugeDescriptionLabel = ({ label: label2, className, yOffset = 0 }) => /* @__PURE__ */ jsxRuntime.jsx(jsxRuntime.Fragment, { children: label2 && /* @__PURE__ */ jsxRuntime.jsx(
    "text",
    {
      x: "0",
      y: yOffset - 20,
      textAnchor: "middle",
      alignmentBaseline: "middle",
      className: classNames(className, css$4.stackedDescriptionLabel),
      children: label2
    }
  ) });
  const RadialGauge = ({
    ...
    const renderSeries = react.useCallback(
      ({ chartHeight, chartWidth }) => {
        ...
        if (Array.isArray(maxValue)) {
          scale = maxValue.map(
            (max, index) => d3Scale.scaleLinear().domain([(minValue == null ? void 0 : minValue[index]) ?? (minValue == null ? void 0 : minValue[0]) ?? minValue, max]).range([startAngle, endAngle])
          );
        } else if (Array.isArray(minValue)) {
          scale = minValue.map(
            (min, index) => d3Scale.scaleLinear().domain([min, (maxValue == null ? void 0 : maxValue[index]) ?? (maxValue == null ? void 0 : maxValue[0]) ?? maxValue]).range([startAngle, endAngle])
          );
        } else {
  ...
  const modifiers = [dom.offset({ mainAxis: 0, crossAxis: 3 })];
  const HeatmapCell = ({
    rx = 2,
    ry = 2,
    cursor = "auto",
    ...
    return /* @__PURE__ */ jsxRuntime.jsxs(react.Fragment, { children: [
      /* @__PURE__ */ jsxRuntime.jsx("g", { ref: rect, children: renderedSymbol ? /* @__PURE__ */ jsxRuntime.jsx(
        react$1.motion.g,
        {
          ...rest,
          fill,
        ...
        react$1.motion.rect,
        {
          ...
          ry,
          style: { ...extras.style, cursor },
          className: classNames(css$3.cell, extras.className),
          initial: {
            opacity: 0
          },
          animate: {
  ...
  const HEATMAP_SERIES_DEFAULT_PROPS = {
    padding: 0.1,
    animated: true,
  ...
  const Heatmap = ({
    ...
    const getScalesData = react.useCallback(
      (chartHeight, chartWidth) => {
        ...
        const xDomain = xAxisProps.domain || uniqueBy(nestedData, (d) => d.key);
        const xScale = d3Scale.scaleBand().range([0, chartWidth]).domain(xDomain).paddingInner(seriesProps.padding || 0.1);
        const yDomain = yAxisProps.domain || uniqueBy(
          nestedData,
          (d) => d.data,
          (d) => d.x
        );
        const yScale = d3Scale.scaleBand().domain(yDomain).range([chartHeight, 0]).paddingInner(seriesProps.padding || 0.1);
        return {
          yScale,
          xScale,
          data: nestedData
  ...
  const buildDataScales = (rawData, view) => {
    ...
    let end2, start2;
    if (view === "year") {
      end2 = getStartOfDay(d3Array.max(rawData, (d) => d.key) || /* @__PURE__ */ new Date());
      start2 = getStartOfDay(subDays(end2));
    } else {
  ...
  const CalendarHeatmap = ({
    ...
    const getDayOfWeek = react.useCallback((day) => weekDays[day], []);
    const yAxisLabelFormat = react.useMemo(
      () => view === "year" ? getDayOfWeek : () => null,
      [getDayOfWeek, view]
    );
    const xAxisLabelFormat = react.useCallback(
      (weeks) => addWeeksToDate(start2, weeks).toLocaleString("default", { month: "long" }),
      [start2]
    );
    return /* @__PURE__ */ jsxRuntime.jsx(
      Heatmap,
  ...
  const LinearGaugeBar = (props) => /* @__PURE__ */ jsxRuntime.jsx(
    Bar,
    {
      tooltip: /* @__PURE__ */ jsxRuntime.jsx(
        ChartTooltip,
  ...
  const LinearGaugeSeries = ({
    height,
    width,
    bar: bar2 = /* @__PURE__ */ jsxRuntime.jsx(LinearGaugeBar, {}),
    outerBar: outerBar2 = /* @__PURE__ */ jsxRuntime.jsx(LinearGaugeOuterBar, {}),
    isMultiSeries,
    ...rest
    ...
    /* @__PURE__ */ jsxRuntime.jsx(
      BarSeries,
      {
        ...
        layout: "horizontal",
        tooltip: null,
        bar: /* @__PURE__ */ jsxRuntime.jsx(reablocks.CloneElement, { element: bar2 })
      }
    )
  ] });
  const LinearGauge = ({
  ...
  const useInterpolate$1 = ({ data, animated }) => {
    ...
    const d = react$1.useMotionValue(data.path);
    const spring = react$1.useSpring(0, { stiffness: 300, damping: 30 });
    react.useEffect(() => {
      const interpolator = d3Interpolate.interpolate(d.get(), data.path);
      const prevSpring = spring.get();
  ...
  const VennArc = ({
    ...
    strokeWidth = 3,
    gradient: gradient2 = /* @__PURE__ */ jsxRuntime.jsx(Gradient, {}),
    glow,
    tooltip: tooltip2 = /* @__PURE__ */ jsxRuntime.jsx(ChartTooltip, {}),
    onClick = () => void 0,
    onMouseEnter = () => void 0,
  ...
  const VennSeries = ({
    ...
    label: label2 = /* @__PURE__ */ jsxRuntime.jsx(VennLabel, {})
  }) => {
  ...
  const BubbleSeries = ({
    ...
    format,
    label: label2 = /* @__PURE__ */ jsxRuntime.jsx(BubbleLabel, {})
  }) => {
    const transition = animated ? DEFAULT_TRANSITION : { type: false, delay: 0 };
  ...
  const TreeMapSeries = ({
    ...
    label: label2 = /* @__PURE__ */ jsxRuntime.jsx(TreeMapLabel, {})
  }) => {
    const transition = animated ? DEFAULT_TRANSITION : { type: false, delay: 0 };
  ...
  const clickable$1 = "_clickable_18e6r_77";
  ...
  const BarListSeries = ({
    ...
    const renderBar = react.useCallback(
      (item2, index) => {
        ...
        return /* @__PURE__ */ jsxRuntime.jsx("div", { className: classNames(css$2.outerBar, outerBarClassName), children: /* @__PURE__ */ jsxRuntime.jsx(
          react$1.motion.div,
          {
            transition: DEFAULT_TRANSITION,
            className: classNames(css$2.bar, barClassName),
            initial: { width: "0%" },
    ...
    return /* @__PURE__ */ jsxRuntime.jsx(jsxRuntime.Fragment, { children: data.map((d, i) => {
      ...
      return /* @__PURE__ */ jsxRuntime.jsxs(
        ...
        {
          role: "listitem",
          className: classNames(css$2.item, itemClassName, {
            [css$2.clickable]: onItemClick,
            [css$2.valueBottom]: valuePosition === "bottom",
            [css$2.valueStart]: valuePosition === "start",
            [css$2.valueEnd]: valuePosition === "end",
            [css$2.valueNone]: valuePosition === "none",
            [css$2.labelBottom]: labelPosition === "bottom",
            [css$2.labelTop]: labelPosition === "top",
            [css$2.labelStart]: labelPosition === "start",
            [css$2.labelEnd]: labelPosition === "end",
            [css$2.labelNone]: labelPosition === "none"
          }),
          ...
          children: [
            /* @__PURE__ */ jsxRuntime.jsx(
              ...
              {
                title: label2,
                className: classNames(css$2.label, labelClassName),
                children: label2
              }
            ),
            renderBar(d, i),
            /* @__PURE__ */ jsxRuntime.jsx(
              ...
              {
                title: valueLabel2,
                className: classNames(css$2.valueLabel, valueClassName),
  ...
  const BarList = ({
    ...
    return /* @__PURE__ */ jsxRuntime.jsx(
      react$1.motion.section,
      {
        ...
        className,
        style,
        children: /* @__PURE__ */ jsxRuntime.jsx(reablocks.CloneElement, { element: series, data: mashedData })
      }
    );
  };
  const MeterColumn = ({
  ...
  const RadarChartSeries = (props) => /* @__PURE__ */ jsxRuntime.jsx(RadialAreaSeries, { ...RADAR_CHART_SERIES_DEFAULT_PROPS, ...props });
      ...
      RadialAreaChart,
      {
        ...
        series: /* @__PURE__ */ jsxRuntime.jsx(
          RadarChartSeries,
          {
            ...
            ...(_a = props == null ? void 0 : props.series) == null ? void 0 : _a.props
          }
        ),
        axis: /* @__PURE__ */ jsxRuntime.jsx(
          RadialAxis,
  ...
  const FUNNEL_ARC_DEFAULT_PROPS = {
    gradient: /* @__PURE__ */ jsxRuntime.jsx(
      Gradient,
      {
        direction: "horizontal",
  ...
  const FunnelAxis = ({
    ...
    xScale,
    yScale,
    line: line2 = /* @__PURE__ */ jsxRuntime.jsx(FunnelAxisLine, {}),
    label: label2 = /* @__PURE__ */ jsxRuntime.jsx(FunnelAxisLabel, {})
  }) => {
  ...
  const FunnelSeries = ({
    ...
    const arcProps = react.useMemo(
      () => ({ ...FUNNEL_ARC_DEFAULT_PROPS, ...(arc == null ? void 0 : arc.props) ?? {} }),
      [arc == null ? void 0 : arc.props]
    );
    const getScales = react.useCallback(
      (height2, width2) => {
        const yScale = d3Scale.scaleLinear().domain([-d3Array.max(data, ({ data: data2 }) => data2), d3Array.max(data, ({ data: data2 }) => data2)]).nice().range([height2, 0]);
  ...
  const useInterpolate = ({ animated, initial, path: path2 }) => {
    ...
    const d = react$1.useMotionValue(initial);
    const spring = react$1.useSpring(0, { stiffness: 300, damping: 30 });
    react.useEffect(() => {
      const interpolator = d3Interpolate.interpolate(d.get(), path2);
      const prevSpring = spring.get();
      spring.set(1 + prevSpring);
      return spring.on("change", (v) => d.set(interpolator(v - prevSpring)));
    }, [d, path2, spring]);
  ...
  const SunburstArc = ({
    ...
    const getPath = react.useCallback(
      (item2) => {
        return d3Shape.arc().startAngle((d2) => d2.x0).endAngle((d2) => d2.x1).padAngle((d2) => Math.min((d2.x1 - d2.x0) / 2, 5e-3)).padRadius(radius / 2).innerRadius((d2) => d2.y0).outerRadius((d2) => d2.y1 - 1)(item2);
      },
      [radius]
    );
  ...
  const SunburstSeries = ({
    ...
    colorScheme = "cybertron",
    animated = true,
    arc = /* @__PURE__ */ jsxRuntime.jsx(SunburstArc, {}),
    label: label2 = /* @__PURE__ */ jsxRuntime.jsx(SunburstArcLabel, {})
  }) => {
    const getFill = react.useCallback(
      (item2, index) => {
        let parent = item2;
    ...
    const renderItem = react.useCallback(
      (item2, index) => {
        ...
        const safeKey = safeIdentifier.identifier(itemId);
        return /* @__PURE__ */ jsxRuntime.jsxs(react.Fragment, { children: [
          /* @__PURE__ */ jsxRuntime.jsx(
            reablocks.CloneElement,
            {
      ...
      [animated, arc, getFill, id, label2, radius]
    );
    return /* @__PURE__ */ jsxRuntime.jsx(jsxRuntime.Fragment, { children: data.map(renderItem) });
  };
  const SunburstChart = ({
    data = [],
    id,
    series = /* @__PURE__ */ jsxRuntime.jsx(SunburstSeries, {}),
    containerClassName,
    width,
    height,
    className,
    ...
    const getData = react.useCallback(
      (radius) => {
        const rootHierarchy = d3Hierarchy.hierarchy({ data }, (d) => d.data).sum((d) => d.data).sort((a, b) => b.data - a.data);
        const root = d3Hierarchy.partition().size([2 * Math.PI, radius])(rootHierarchy);
        const nodes = [];
        const getAllNodes = (node2) => {
          if (node2 == null ? void 0 : node2.parent) {
            nodes.push(node2);
  ...
  const wordLabel = "_wordLabel_uwka2_1";
  const clickable = "_clickable_uwka2_5";
  const css = {
    wordLabel,
    clickable
  };
  ...
  const WordCloud = ({
    ...
    const buildData2 = react.useCallback(
      (chartWidth, chartHeight) => {
        const sizeScale = d3Scale.scaleLinear().domain([0, d3Array.max(data, (d) => Number(d.data)) || 0]).range(fontSizeRange);
        const layout = cloud().size([chartWidth, chartHeight]).words(
          data.map((d, index) => ({
            text: String(d.key),
        ...
        ).padding(padding).font(fontFamily).fontSize((d) => d.size).rotate(
          () => rotations > 0 ? Math.floor(Math.random() * rotations) * (rotationAngles[1] - rotationAngles[0]) / (rotations - 1) + rotationAngles[0] : 0
        );
        layout.start();
    ...
    const renderChart = react.useCallback(
      ({ chartHeight, chartWidth }) => {
        const words = buildData2(chartWidth, chartHeight);
        return words.map((word, i) => /* @__PURE__ */ jsxRuntime.jsx(
          WordCloudLabel,
          {
            text: word.text,
            fontSize: word.size,
      ...
      [buildData2, fontFamily, onLabelClick, onLabelMouseEnter, onLabelMouseLeave]
    );
    return /* @__PURE__ */ jsxRuntime.jsx(
      ChartContainer,
      {
  ...
  exports2.AREA_CHART_DEFAULT_PROPS = AREA_CHART_DEFAULT_PROPS;
  exports2.AREA_DEFAULT_PROPS = AREA_DEFAULT_PROPS;
  exports2.AREA_SERIES_DEFAULT_PROPS = AREA_SERIES_DEFAULT_PROPS;
  exports2.Area = Area;
  exports2.AreaChart = AreaChart;
  exports2.AreaSeries = AreaSeries;
  exports2.AreaSparklineChart = AreaSparklineChart;
  exports2.BAR_DEFAULT_PROPS = BAR_DEFAULT_PROPS;
  exports2.BAR_LABEL_DEFAULT_PROPS = BAR_LABEL_DEFAULT_PROPS;
  exports2.BAR_SERIES_DEFAULT_PROPS = BAR_SERIES_DEFAULT_PROPS;
  exports2.Bar = Bar;
  ...
  exports2.FUNNEL_ARC_DEFAULT_PROPS = FUNNEL_ARC_DEFAULT_PROPS;
  ...
  exports2.GRID_LINE_DEFAULT_PROPS = GRID_LINE_DEFAULT_PROPS;
  exports2.GRID_STRIPE_DEFAULT_PROPS = GRID_STRIPE_DEFAULT_PROPS;
  ...
  exports2.HEATMAP_SERIES_DEFAULT_PROPS = HEATMAP_SERIES_DEFAULT_PROPS;
  exports2.HISTOGRAM_BAR_SERIES_DEFAULT_PROPS = HISTOGRAM_BAR_SERIES_DEFAULT_PROPS;
  ...
  exports2.LINEAR_AXIS_DEFAULT_PROPS = LINEAR_AXIS_DEFAULT_PROPS;
  exports2.LINEAR_AXIS_TICK_LABEL_DEFAULT_PROPS = LINEAR_AXIS_TICK_LABEL_DEFAULT_PROPS;
  exports2.LINEAR_AXIS_TICK_LINE_DEFAULT_PROPS = LINEAR_AXIS_TICK_LINE_DEFAULT_PROPS;
  exports2.LINEAR_AXIS_TICK_SERIES_DEFAULT_PROPS = LINEAR_AXIS_TICK_SERIES_DEFAULT_PROPS;
  exports2.LINEAR_X_AXIS_DEFAULT_PROPS = LINEAR_X_AXIS_DEFAULT_PROPS;
  exports2.LINEAR_X_AXIS_TICK_LABEL_DEFAULT_PROPS = LINEAR_X_AXIS_TICK_LABEL_DEFAULT_PROPS;
  exports2.LINEAR_X_AXIS_TICK_LINE_DEFAULT_PROPS = LINEAR_X_AXIS_TICK_LINE_DEFAULT_PROPS;
  exports2.LINEAR_X_AXIS_TICK_SERIES_DEFAULT_PROPS = LINEAR_X_AXIS_TICK_SERIES_DEFAULT_PROPS;
  exports2.LINEAR_Y_AXIS_DEFAULT_PROPS = LINEAR_Y_AXIS_DEFAULT_PROPS;
  exports2.LINEAR_Y_AXIS_TICK_LABEL_DEFAULT_PROPS = LINEAR_Y_AXIS_TICK_LABEL_DEFAULT_PROPS;
  exports2.LINEAR_Y_AXIS_TICK_LINE_DEFAULT_PROPS = LINEAR_Y_AXIS_TICK_LINE_DEFAULT_PROPS;
  exports2.LINEAR_Y_AXIS_TICK_SERIES_DEFAULT_PROPS = LINEAR_Y_AXIS_TICK_SERIES_DEFAULT_PROPS;
  exports2.Line = Line;
  ...
  exports2.LinearValueMarker = LinearValueMarker;
  ...
  exports2.MARIMEKKO_BAR_SERIES_DEFAULT_PROPS = MARIMEKKO_BAR_SERIES_DEFAULT_PROPS;
  exports2.Map = Map$1;
  ...
  exports2.Move = Move;
  exports2.PIE_ARC_LABEL_DEFAULT_PROPS = PIE_ARC_LABEL_DEFAULT_PROPS;
  exports2.PIE_ARC_SERIES_DEFAULT_PROPS = PIE_ARC_SERIES_DEFAULT_PROPS;
  exports2.POINT_SERIES_DEFAULT_PROPS = POINT_SERIES_DEFAULT_PROPS;
  exports2.Pan = Pan;
  ...
  exports2.RADAR_CHART_SERIES_DEFAULT_PROPS = RADAR_CHART_SERIES_DEFAULT_PROPS;
  exports2.RADIAL_AREA_SERIES_DEFAULT_PROPS = RADIAL_AREA_SERIES_DEFAULT_PROPS;
  exports2.RADIAL_AXIS_ARC_DEFAULT_PROPS = RADIAL_AXIS_ARC_DEFAULT_PROPS;
  exports2.RADIAL_AXIS_ARC_LINE_DEFAULT_PROPS = RADIAL_AXIS_ARC_LINE_DEFAULT_PROPS;
  exports2.RADIAL_AXIS_ARC_SERIES_DEFAULT_PROPS = RADIAL_AXIS_ARC_SERIES_DEFAULT_PROPS;
  exports2.RADIAL_AXIS_DEFAULT_PROPS = RADIAL_AXIS_DEFAULT_PROPS;
  exports2.RADIAL_AXIS_TICK_LINE_DEFAULT_PROPS = RADIAL_AXIS_TICK_LINE_DEFAULT_PROPS;
  exports2.RADIAL_POINT_SERIES_DEFAULT_PROPS = RADIAL_POINT_SERIES_DEFAULT_PROPS;
  exports2.RADIAL_SCATTER_POINT_DEFAULT_PROPS = RADIAL_SCATTER_POINT_DEFAULT_PROPS;
  ...
  exports2.RadialValueMarker = RadialValueMarker;
  exports2.RangeLines = RangeLines;
  exports2.SCATTER_POINT_DEFAULT_PROPS = SCATTER_POINT_DEFAULT_PROPS;
  exports2.STACKED_BAR_SERIES_DEFAULT_PROPS = STACKED_BAR_SERIES_DEFAULT_PROPS;
  exports2.STACKED_NORMALIZED_BAR_SERIES_DEFAULT_PROPS = STACKED_NORMALIZED_BAR_SERIES_DEFAULT_PROPS;
  ...
  exports2.SunburstArc = SunburstArc;
  exports2.SunburstArcLabel = SunburstArcLabel;
  exports2.SunburstChart = SunburstChart;
  exports2.SunburstSeries = SunburstSeries;
  ...
  exports2.WordCloud = WordCloud;
  exports2.WordCloudLabel = WordCloudLabel;
  exports2.Zoom = Zoom;
  ...
  exports2.createColorSchemeValueScales = createColorSchemeValueScales;
  exports2.extent = extent;
  exports2.formatValue = formatValue;
  exports2.functionProps = functionProps;
  exports2.getAriaLabel = getAriaLabel;
  exports2.getClosestBandScalePoint = getClosestBandScalePoint;
  exports2.getClosestContinousScalePoint = getClosestContinousScalePoint;
  exports2.getColor = getColor;
  exports2.getColorSchemeStyles = getColorSchemeStyles;
  ...
  exports2.linearAxisLineDefaultProps = linearAxisLineDefaultProps;
  exports2.mergeDefaultProps = mergeDefaultProps;
  ...
  exports2.roundDecimals = roundDecimals;
