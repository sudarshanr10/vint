...
import { useRef, useCallback, useState, useEffect, Fragment, useMemo, createRef, Children, cloneElement, createContext, useContext, Component, forwardRef, useImperativeHandle, createElement, isValidElement } from "react";
import humanFormat from "human-format";
import { min, max, bisector, range, median, histogram, extent as extent$1, maxIndex } from "d3-array";
import { curveMonotoneX, curveStep, curveLinear, arc, line as line$1, stack, stackOffsetExpand, stackOffsetDiverging, area, pie, radialArea, curveCardinalClosed, curveCardinal, curveLinearClosed, radialLine } from "d3-shape";
...
import { useMotionValue, useSpring, motion, animate } from "motion/react";
  ...
  return /* @__PURE__ */ jsxs(
    "g",
    {
      ...
      children: [
        ...
        (tickSeriesProps.line || tickSeriesProps.label) && /* @__PURE__ */ jsx(
          CloneElement,
          {
            element: tickSeries,
            height,
...
const LinearXAxisTickLabel = (props) => /* @__PURE__ */ jsx(
  LinearAxisTickLabel,
  {
...
const LinearXAxisTickLine = (props) => /* @__PURE__ */ jsx(
  LinearAxisTickLine,
  {
...
const LinearXAxisTickSeries = (props) => {
  ...
  return /* @__PURE__ */ jsx(
    ...
    {
      ...xTickSeriesProps,
      line: (xTickSeriesProps == null ? void 0 : xTickSeriesProps.line) ? /* @__PURE__ */ jsx(
        LinearXAxisTickLine,
        {
          ...mergeDefaultProps(
      ...
      label: (xTickSeriesProps == null ? void 0 : xTickSeriesProps.label) ? /* @__PURE__ */ jsx(
...
const LINEAR_X_AXIS_TICK_SERIES_DEFAULT_PROPS = {
  ...LINEAR_AXIS_TICK_SERIES_DEFAULT_PROPS,
  tickSize: 75,
  line: /* @__PURE__ */ jsx(LinearXAxisTickLine, { ...LINEAR_X_AXIS_TICK_LINE_DEFAULT_PROPS }),
  label: /* @__PURE__ */ jsx(LinearXAxisTickLabel, { ...LINEAR_X_AXIS_TICK_LABEL_DEFAULT_PROPS })
};
const LinearXAxis = (props) => {
  ...
  return /* @__PURE__ */ jsx(
    ...
    {
      ...xAxisProps,
      tickSeries: xAxisProps.tickSeries && /* @__PURE__ */ jsx(
...
const LinearYAxisTickLabel = (props) => /* @__PURE__ */ jsx(
  LinearAxisTickLabel,
  {
...
const LinearYAxisTickLine = (props) => /* @__PURE__ */ jsx(
  LinearAxisTickLine,
  {
...
const LinearYAxisTickSeries = (props) => {
  ...
  return /* @__PURE__ */ jsx(
    ...
    {
      ...yTickSeriesProps,
      line: (yTickSeriesProps == null ? void 0 : yTickSeriesProps.line) ? /* @__PURE__ */ jsx(
        LinearYAxisTickLine,
        {
          ...mergeDefaultProps(
      ...
      label: (yTickSeriesProps == null ? void 0 : yTickSeriesProps.label) ? /* @__PURE__ */ jsx(
...
const LINEAR_Y_AXIS_TICK_SERIES_DEFAULT_PROPS = {
  ...LINEAR_AXIS_TICK_SERIES_DEFAULT_PROPS,
  tickSize: 30,
  line: /* @__PURE__ */ jsx(LinearYAxisTickLine, { ...LINEAR_Y_AXIS_TICK_LINE_DEFAULT_PROPS }),
  label: /* @__PURE__ */ jsx(LinearYAxisTickLabel, { ...LINEAR_Y_AXIS_TICK_LABEL_DEFAULT_PROPS })
};
const LinearYAxis = (props) => {
  ...
  return /* @__PURE__ */ jsx(
    ...
    {
      ...yAxisProps,
      tickSeries: yAxisProps.tickSeries && /* @__PURE__ */ jsx(
...
const RadialAxisTick = ({
  line: line2 = /* @__PURE__ */ jsx(RadialAxisTickLine, {}),
  label: label2 = /* @__PURE__ */ jsx(RadialAxisTickLabel, {}),
  scale: scale2,
  outerRadius = 0,
  data,
  index,
...
const RadialAxisArc = (props) => {
  var _a, _b, _c, _d;
  const { index, stroke, strokeDasharray, scale: scale2, startAngle, endAngle } = {
  ...
  return /* @__PURE__ */ jsx(
    Move,
    {
      ...
      children: /* @__PURE__ */ jsxs("g", { children: [
        /* @__PURE__ */ jsx("line", { className: css$t.line, y1: "0", y2: height, x1: "5", x2: "5" }),
        /* @__PURE__ */ jsx(
          "rect",
          {
        ...
        /* @__PURE__ */ jsx(
          "g",
          {
            ...
            style: { pointerEvents: "none" },
            children: range(5).map((i) => /* @__PURE__ */ jsx("circle", { cy: i * 5, cx: "5", r: ".5", className: css$t.dot }, i))
          }
        )
      ] })
    }
...
const BrushSlice = (props) => {
  ...
  return /* @__PURE__ */ jsxs(Fragment, { children: [
    /* @__PURE__ */ jsx("rect", { className: css$s.unsliced, height, width: start2 }),
    /* @__PURE__ */ jsx(
      "rect",
      {
...
const DiscreteLegendEntry = ({
  label: label2,
  symbol: symbol2 = /* @__PURE__ */ jsx(DiscreteLegendSymbol, {}),
  title,
  className,
  color,
  style,
  ...
  "div",
  {
    ...
    children: [
      ...
      /* @__PURE__ */ jsx("span", { className: css$o.label, children: label2 })
    ]
  }
);
...
const SequentialLegend = ({
  ...
  return /* @__PURE__ */ jsxs(
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ jsx("div", { className: css$n.start, children: formatValue(start2) }),
        /* @__PURE__ */ jsx(
          "div",
          {
        ...
        /* @__PURE__ */ jsx("div", { className: css$n.end, children: formatValue(end2) })
      ]
    }
  );
};
...
const GridStripe = (props) => {
  const { fill, className, position, data, height, width, scale: scale2, index } = {
  ...
  return /* @__PURE__ */ jsx("rect", { className: classNames(css$l.gridStripe, className), ...coords });
};
const GRID_STRIPE_DEFAULT_PROPS = {
  fill: "#393c3e"
};
const GridlineSeries = ({
  line: line2 = /* @__PURE__ */ jsx(Gridline, { direction: "all" }),
  stripe,
  yScale,
  xScale,
  yAxis,
...
const TooltipTemplate = ({
  ...
  const renderValues = (data, index) => {
    ...
    return /* @__PURE__ */ jsxs("span", { className: css$j.subValue, children: [
      /* @__PURE__ */ jsx("span", { className: css$j.subValueColor, style: { backgroundColor: fill } }),
      /* @__PURE__ */ jsxs("span", { className: css$j.subValueName, children: [
  ...
  return /* @__PURE__ */ jsxs("div", { className, role: "tooltip", children: [
    /* @__PURE__ */ jsx("div", { className: css$j.label, children: formatValue(value2.x) }),
    /* @__PURE__ */ jsxs("div", { className: css$j.value, children: [
...
const ScatterSeries = ({
  ...
  isZoomed,
  activeIds,
  point: point2 = /* @__PURE__ */ jsx(ScatterPoint, {}),
  valueMarkers,
  xScale,
  yScale,
  ...rest
...
const Area = (props) => {
  ...
  const getAreaPath = useCallback(
    (d) => {
      ...
      const fn = area().x((d2) => roundDecimals(d2.x)).y0((d2) => roundDecimals(d2.y0)).y1((d2) => roundDecimals(d2.y1)).curve(interpolate(interpolation));
      return fn(d);
    },
    [interpolation, total]
  );
...
const Line = ({
  ...
  const getLinePath = useCallback(
    (point2) => {
      const fn = line$1().x((d) => roundDecimals(d.x)).y((d) => roundDecimals(d.y1)).defined((d) => showZeroStroke || calculateShowStroke(d, point2)).curve(interpolate(interpolation));
      return fn(point2);
    },
...
const StackedAreaChart = (props) => {
  ...
  return /* @__PURE__ */ jsx(
    ...
    {
      ...props,
      series: /* @__PURE__ */ jsx(StackedAreaSeries, { ...(_a = props.series) == null ? void 0 : _a.props, type: "stacked" })
    }
  );
};
...
const BarSeries = (props) => {
  ...
  const renderBar = useCallback(
    (data2, barIndex, barCount, groupIndex) => {
      ...
      if (!bar2) {
        barElements = /* @__PURE__ */ jsx(Bar, { ...BAR_DEFAULT_PROPS });
      }
  ...
  const renderValueMarkers = useCallback(
    () => /* @__PURE__ */ jsx(Fragment$1, { children: (valueMarkers == null ? void 0 : valueMarkers.length) && valueMarkers.map((marker2) => /* @__PURE__ */ jsx(
      CloneElement,
      {
        ...
        direction: layout2 === "vertical" ? "horizontal" : "vertical"
      },
      marker2.key
    )) }),
...
const StackedBarSeries = (props) => /* @__PURE__ */ jsx(BarSeries, { ...STACKED_BAR_SERIES_DEFAULT_PROPS, ...props });
...
const StackedNormalizedBarSeries = (props) => /* @__PURE__ */ jsx(BarSeries, { ...STACKED_NORMALIZED_BAR_SERIES_DEFAULT_PROPS, ...props });
...
const MarimekkoBarSeries = (props) => /* @__PURE__ */ jsx(BarSeries, { ...MARIMEKKO_BAR_SERIES_DEFAULT_PROPS, ...props });
...
const HistogramBarSeries = ({
  type,
  ...rest
}) => /* @__PURE__ */ jsx(BarSeries, { ...HISTOGRAM_BAR_SERIES_DEFAULT_PROPS, ...rest });
...
const BarChart = (props) => {
  ...
  const getMultiGroupScales = useCallback(
    (aggregatedData, height2, width2) => {
      const { groupPadding, layout: layout2 } = seriesProps;
  ...
  const getScalesAndData = useCallback(
    (chartHeight, chartWidth) => {
      const { type, layout: layout2 } = seriesProps;
...
const MarimekkoChart = (props) => /* @__PURE__ */ jsx(
  BarChart,
  {
...
const StackedBarChart = (props) => /* @__PURE__ */ jsx(
  BarChart,
  {
    ...props,
    series: /* @__PURE__ */ jsx(
...
const StackedNormalizedBarChart = (props) => /* @__PURE__ */ jsx(
  BarChart,
  {
...
const HistogramBarChart = (props) => /* @__PURE__ */ jsx(
  BarChart,
  {
    ...props,
    series: /* @__PURE__ */ jsx(
...
const LineSeries = (props) => /* @__PURE__ */ jsx(AreaSeries, { area: null, line: /* @__PURE__ */ jsx(Line, { strokeWidth: 3 }), ...props });
const LineChart = (props) => /* @__PURE__ */ jsx(AreaChart, { series: /* @__PURE__ */ jsx(LineSeries, {}), ...props });
const Map$1 = ({
  id,
  width,
  height,
...
const SankeyLink = ({
  ...
  source,
  target,
  tooltip: tooltip2 = /* @__PURE__ */ jsx(Tooltip, { theme: tooltipTheme, followCursor: true, modifiers: [offset(5)] }),
  chartId,
  value: value2,
  active = false,
  animated = true,
  ...
  const renderTooltipContent = useCallback(() => {
    return /* @__PURE__ */ jsxs("div", { className: css$a.tooltip, children: [
      /* @__PURE__ */ jsx("div", { className: css$a.tooltipLabel, children: `${source.title} → ${target.title}` }),
      /* @__PURE__ */ jsx("div", { className: css$a.tooltipValue, children: formatValue(value2) })
    ] });
...
const SankeyNode = ({
  ...
  animated = true,
  chartWidth,
  label: label2 = /* @__PURE__ */ jsx(SankeyLabel, {}),
  labelPosition,
  labelPadding,
  tooltip: tooltip2 = /* @__PURE__ */ jsx(Tooltip, { theme: tooltipTheme, followCursor: true, modifiers: [offset(5)] }),
  title,
  ...
  const renderTooltipContent = useCallback(() => {
    return /* @__PURE__ */ jsxs("div", { className: css$9.tooltip, children: [
      /* @__PURE__ */ jsx("div", { className: css$9.tooltipLabel, children: title }),
...
const SparklineChart = (props) => /* @__PURE__ */ jsx(
  LineChart,
  {
    gridlines: null,
    series: /* @__PURE__ */ jsx(
...
const AreaSparklineChart = (props) => /* @__PURE__ */ jsx(
  AreaChart,
  {
    gridlines: null,
    series: /* @__PURE__ */ jsx(
...
const BarSparklineChart = (props) => /* @__PURE__ */ jsx(
  BarChart,
  {
    gridlines: null,
...
const RadialArea = ({
  ...
  innerRadius,
  interpolation,
  gradient: gradient2 = /* @__PURE__ */ jsx(RadialGradient, {}),
  isClosedCurve = true
}) => {
  const transition = useMemo(
    () => animated ? {
...
const RadialScatterSeries = ({
  data,
  point: point2 = /* @__PURE__ */ jsx(RadialScatterPoint, {}),
  xScale,
  yScale,
  animated = true,
  activeIds,
...
const RadialBarSeries = ({
  ...
  height,
  width,
  tooltip: tooltip2 = /* @__PURE__ */ jsx(TooltipArea, { tooltip: /* @__PURE__ */ jsx(ChartTooltip, { followCursor: true }) }),
  colorScheme = schemes.cybertron[0],
  bar: bar2 = /* @__PURE__ */ jsx(RadialBar, {}),
  animated = true,
  startAngle = 0,
  endAngle = 2 * Math.PI,
  type = "standard",
...
const RadialGaugeOuterArc = (props) => /* @__PURE__ */ jsx(RadialGaugeArc, { animated: false, disabled: true, ...props });
const RadialGaugeSeries = ({
  ...
  label: label2 = /* @__PURE__ */ jsx(RadialGaugeLabel, {}),
  valueLabel: valueLabel2 = /* @__PURE__ */ jsx(RadialGaugeValueLabel, {}),
  colorScheme = ["#00ECB1"],
  id,
  padding = 20,
  minGaugeWidth = 50,
...
const StackedRadialGaugeValueLabel = ({ label: label2, className, yOffset = 0 }) => /* @__PURE__ */ jsx(Fragment$1, { children: label2 && /* @__PURE__ */ jsx(
  "text",
  {
    x: "0",
    y: yOffset,
...
const StackedRadialGaugeSeries = ({
  ...
  label: label2 = /* @__PURE__ */ jsx(StackedRadialGaugeValueLabel, {}),
  descriptionLabel,
  colorScheme = ["#00ECB1"],
  fillFactor = 0.2,
  arcPadding = 0.15
...
const StackedRadialGaugeDescriptionLabel = ({ label: label2, className, yOffset = 0 }) => /* @__PURE__ */ jsx(Fragment$1, { children: label2 && /* @__PURE__ */ jsx(
  "text",
  {
    x: "0",
    y: yOffset - 20,
...
const Heatmap = ({
  ...
  const getScalesData = useCallback(
    (chartHeight, chartWidth) => {
      ...
      const xScale = scaleBand().range([0, chartWidth]).domain(xDomain).paddingInner(seriesProps.padding || 0.1);
      const yDomain = yAxisProps.domain || uniqueBy(
        nestedData,
        (d) => d.data,
        (d) => d.x
      );
      const yScale = scaleBand().domain(yDomain).range([chartHeight, 0]).paddingInner(seriesProps.padding || 0.1);
      return {
        yScale,
        xScale,
        data: nestedData
...
const CalendarHeatmap = ({
  ...
  const getDayOfWeek = useCallback((day) => weekDays[day], []);
...
const LinearGaugeBar = (props) => /* @__PURE__ */ jsx(
  Bar,
  {
    tooltip: /* @__PURE__ */ jsx(
      ChartTooltip,
...
const LinearGaugeSeries = ({
  height,
  width,
  bar: bar2 = /* @__PURE__ */ jsx(LinearGaugeBar, {}),
  outerBar: outerBar2 = /* @__PURE__ */ jsx(LinearGaugeOuterBar, {}),
  isMultiSeries,
  ...rest
...
const VennArc = ({
  ...
  strokeWidth = 3,
  gradient: gradient2 = /* @__PURE__ */ jsx(Gradient, {}),
  glow,
  tooltip: tooltip2 = /* @__PURE__ */ jsx(ChartTooltip, {}),
  onClick = () => void 0,
  onMouseEnter = () => void 0,
...
const VennSeries = ({
  ...
  arc: arc2 = /* @__PURE__ */ jsx(VennArc, {}),
  label: label2 = /* @__PURE__ */ jsx(VennLabel, {})
}) => {
...
const BubbleSeries = ({
  ...
  format,
  label: label2 = /* @__PURE__ */ jsx(BubbleLabel, {})
}) => {
  const transition = animated ? DEFAULT_TRANSITION : { type: false, delay: 0 };
...
const TreeMapSeries = ({
  ...
  label: label2 = /* @__PURE__ */ jsx(TreeMapLabel, {})
}) => {
  const transition = animated ? DEFAULT_TRANSITION : { type: false, delay: 0 };
...
const BarListSeries = ({
  ...
  const renderBar = useCallback(
    (item2, index) => {
      ...
      return /* @__PURE__ */ jsx("div", { className: classNames(css$2.outerBar, outerBarClassName), children: /* @__PURE__ */ jsx(
        motion.div,
        {
...
const RadarChartSeries = (props) => /* @__PURE__ */ jsx(RadialAreaSeries, { ...RADAR_CHART_SERIES_DEFAULT_PROPS, ...props });
...
const FunnelAxis = ({
  ...
  xScale,
  yScale,
  line: line2 = /* @__PURE__ */ jsx(FunnelAxisLine, {}),
  label: label2 = /* @__PURE__ */ jsx(FunnelAxisLabel, {})
}) => {
...
const FunnelSeries = ({
  data,
  id,
  arc: arc2 = /* @__PURE__ */ jsx(FunnelArc, {}),
  ...
  const arcProps = useMemo(
    () => ({ ...FUNNEL_ARC_DEFAULT_PROPS, ...(arc2 == null ? void 0 : arc2.props) ?? {} }),
    [arc2 == null ? void 0 : arc2.props]
  );
  const getScales = useCallback(
    (height2, width2) => {
...
const SunburstSeries = ({
  ...
  colorScheme = "cybertron",
  animated = true,
  arc: arc2 = /* @__PURE__ */ jsx(SunburstArc, {}),
  label: label2 = /* @__PURE__ */ jsx(SunburstArcLabel, {})
}) => {
  const getFill = useCallback(
    (item2, index) => {
      let parent = item2;
...
const WordCloud = ({
  ...
  const buildData2 = useCallback(
    (chartWidth, chartHeight) => {
      const sizeScale = scaleLinear().domain([0, max(data, (d) => Number(d.data)) || 0]).range(fontSizeRange);
      const layout2 = cloud().size([chartWidth, chartHeight]).words(
        data.map((d, index) => ({
          text: String(d.key),
  ...
  const renderChart = useCallback(
    ({ chartHeight, chartWidth }) => {
      ...
      return words.map((word, i) => /* @__PURE__ */ jsx(
        WordCloudLabel,
        {
          text: word.text,
          fontSize: word.size,
